...
public class ComplianceRuleServiceImpl implements ComplianceRuleService {
    ...
    public ComplianceRuleServiceImpl(ComplianceRuleRepository complianceRuleRepository) { // [cite: 54]
    ...
    public ComplianceRule getRule(Long id) {
        return complianceRuleRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Rule not found")); // [cite: 285]
    }
}